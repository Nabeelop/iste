...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Projects maintained by SIGs';
    displayName: 'Project';
    pluralName: 'projects';
  ...
  attributes: {
    ...
    slug: Schema.Attribute.UID<'title'> &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    status: Schema.Attribute.Enumeration<['In Progress', 'Live']> &
...
export interface ApiSigSig extends Struct.CollectionTypeSchema {
  collectionName: 'sigs';
  info: {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::sig.sig'> &
      Schema.Attribute.Private;
